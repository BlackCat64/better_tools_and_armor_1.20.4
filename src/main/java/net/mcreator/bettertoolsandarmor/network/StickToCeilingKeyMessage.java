...
public record StickToCeilingKeyMessage(int type, int pressedms) implements CustomPacketPayload {
	public static final ResourceLocation ID = new ResourceLocation(BetterToolsMod.MODID, "key_stick_to_ceiling_key");
	...
	public static void handleData(final StickToCeilingKeyMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		BetterToolsMod.addNetworkMessage(StickToCeilingKeyMessage.ID, StickToCeilingKeyMessage::new, StickToCeilingKeyMessage::handleData);
	}
}
