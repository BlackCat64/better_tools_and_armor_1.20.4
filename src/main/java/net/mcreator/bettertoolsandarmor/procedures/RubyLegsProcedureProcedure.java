	...
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if (!(entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(MobEffects.DIG_SPEED))) {
			...
			if (!(itemstack.getDamageValue() >= itemstack.getMaxDamage() - cost)) {
				...
				if (!(entity instanceof ServerPlayer _plr13 && _plr13.level() instanceof ServerLevel && _plr13.getAdvancements().getOrStartProgress(_plr13.server.getAdvancements().get(new ResourceLocation("better_tools:ruby_sugar_adv"))).isDone())
						&& entity instanceof LivingEntity _livEnt14 && _livEnt14.hasEffect(MobEffects.MOVEMENT_SPEED)) {
					if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem() == BetterToolsModItems.SUGAR_BOOTS.get()
						...
						if (entity instanceof ServerPlayer _player) {
							AdvancementHolder _adv = _player.server.getAdvancements().get(new ResourceLocation("better_tools:ruby_sugar_adv"));
							if (_adv != null) {
